...
# pre one
# cp -r models/muse_pre_L2 models/muse_pre_L2_add
# python hyper_optim.py --train_one --retrain --trials_train=300 --data_x=./data/muse_pre_L2/train_input.txt --data_y=./data/muse_pre_L2/train_output.txt --bound_x=./data/input_limits-W.txt --save_kfold --model_dir=models/muse_pre_L2_add --save_best --lr=0.01 --kfolds=297 --lgk=./data/muse_pre_L2/kf.txt --zero_centering --test_folds="3, 4, 5, 24, 25, 26, 51, 52, 53, 60, 61, 62, 105, 106, 107, 156, 157, 158, 180, 181, 182, 255, 256, 257, 267, 268, 269" --k2r --min_pca=.99999 &> muse_pre_L2_add.log &
# combined
...
# pre N add
cp -r models/muse_pre_N_L2 models/muse_pre_N_L2_add
python hyper_optim.py --train_one --retrain --trials_train=300 --data_x=./data/muse_pre_N_L2/train_input.txt --data_y=./data/muse_pre_N_L2/train_output.txt --bound_x=./data/input_limits-N.txt --save_kfold --model_dir=models/muse_pre_N_L2_add --save_best --lr=0.01 --kfolds=297 --lgk=./data/muse_pre_N_L2/kf.txt --zero_centering --test_folds="6, 7, 8, 54, 55, 56, 60, 61, 62, 72, 73, 74, 81, 82, 83, 168, 169, 170, 189, 190, 191, 192, 193, 194, 282, 283, 284" --k2r --min_pca=.99999 &> muse_pre_N_L2_add.log &
...
# pre add
# cp -r models/muse_pre_L2Hr models/muse_pre_L2Hr_add
# python hyper_optim.py --train_one --retrain --data_x=./data/muse_pre_L2Hr/train_input.txt --data_y=./data/muse_pre_L2Hr/train_output.txt --bound_x=./data/input_limits-W.txt --save_kfold --model_dir=models/muse_pre_L2Hr_add --save_best --lr=0.01 --kfolds=27 --lgk=./data/muse_pre_L2Hr/kf.txt --zero_centering --trials_train=100 --min_pca=.99999 &> muse_pre_L2Hr_add.log &
...
# pre N add
cp -r models/muse_pre_N_L2Hr models/muse_pre_N_L2Hr_add
python hyper_optim.py --train_one --retrain --data_x=./data/muse_pre_N_L2Hr/train_input.txt --data_y=./data/muse_pre_N_L2Hr/train_output.txt --bound_x=./data/input_limits-N.txt --save_kfold --model_dir=models/muse_pre_N_L2Hr_add --save_best --lr=0.01 --kfolds=27 --lgk=./data/muse_pre_N_L2Hr/kf.txt --zero_centering --trials_train=100 --min_pca=.99999 &> muse_pre_N_L2Hr_add.log &
