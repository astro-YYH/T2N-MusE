...
if __name__ == "__main__":
    ...
    if args.train_one:
        ...
        hidden_size_choices_fine = list(range(max(16, best_hidden_size - 16), (best_hidden_size + 16), 2))  
        ...
        decay_lower_fine = best_decay / 2  # Search around the best decay
        decay_upper_fine = best_decay * 2  
