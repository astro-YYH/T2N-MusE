...
# All-2 fine
python hyper_optim.py --k2r --fine_only --decay=3.2079284405890754e-08 --hidden_size=208 --num_layers=7 --trials=80 --r_hidden_size_fine=16 --f_lambda_fine=2 --trials_train=15 --data_x=./data/muse_L2/train_input.txt --data_y=./data/muse_L2/train_output.txt --bound_x=./data/input_limits-W.txt --save_kfold --model_dir=models/muse-All-2_L2 --save_best --lr=0.01 --kfolds=564 --lgk=./data/muse_L2/kf.txt --zero_centering --test_folds="24, 25, 26, 54, 55, 56, 72, 73, 74, 207, 208, 209, 240, 241, 242, 300, 301, 302, 522, 523, 524" --min_pca=.99999 &> muse-All-2_L2_fine.log &
# HO-2 fine
...
# HO-2 smaller search space
# python hyper_optim_smaller.py --fine_only --decay=2.4380034792160635e-07 --hidden_size=448 --num_layers=4 --trials=80 --trials_train=1 --data_x=./data/muse_L2/train_input.txt --data_y=./data/muse_L2/train_output.txt --bound_x=./data/input_limits-W.txt --save_kfold --model_dir=models/muse-HO-2_L2_smaller --save_best --lr=0.01 --kfolds=564 --lgk=./data/muse_L2/kf.txt --zero_centering --test_folds="24, 25, 26, 54, 55, 56, 72, 73, 74, 207, 208, 209, 240, 241, 242, 300, 301, 302, 522, 523, 524" --min_pca=.99999 &> muse-HO-2_L2_fine_smaller.log &
...
# HO-2 fine
# python hyper_optim.py --fine_only --hidden_size=16 --decay=2.959426e-08 --num_layers=7 --trials=80 --r_hidden_size_fine=16 --f_lambda_fine=2 --data_x=./data/muse_L2Hr/train_input.txt --data_y=./data/muse_L2Hr/train_output.txt --bound_x=./data/input_limits-W.txt --save_kfold --model_dir=models/muse-HO-2_L2Hr --save_best --lr=0.01 --kfolds=21 --lgk=./data/muse_L2Hr/kf.txt --zero_centering --trials_train=5 --min_pca=.99999 &> muse-HO-2_L2Hr_fine.log &
