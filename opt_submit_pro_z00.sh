...
# Redshift settings
# ------------------------------
i_z="0"  # Comma-separated redshift indices

# Build suffix like _z000102 from i_z="0,1,2"
suffix="_z$(for z in ${i_z//,/ }; do printf "%02d" "$z"; done | tr -d '\n')"
...
# Fold list for testing (only for L1A and L2)
