...
python train_one.py --data_x=./data/pre_N_L1AL2B_z0/train_input.txt --data_y=./data/pre_N_L1AL2B_z0/train_output.txt --bound_x=./data/narrow/matter_power_297_Box25_Part75_27_Box100_Part300_z0/input_limits.txt --model_dir=models/pre_N_L1AL2B_z0 --lr=0.02 --model_name=best_model --lgk=./data/pre_N_L1AL2B_z0/kf.txt --retrain

LF-HF
python hyper_optim.py --trials=100 --data_x=./data/pre_N_xL-H_z0/train_input.txt --data_y=./data/pre_N_xL-H_z0/train_output.txt --bound_x=./data/narrow/matter_power_297_Box25_Part75_27_Box100_Part300_z0/input_limits.txt --save_kfold --model_dir=models/pre_N_LH_z0 --save_best --lr=0.02 --kfolds=27
# xL-H cut-stitch
python hyper_optim.py --trials=60 --data_x=./data/pre_N_xL-H_stitch_z0/train_input.txt --data_y=./data/pre_N_xL-H_stitch_z0/train_output.txt --bound_x=./data/pre_N_xL-H_stitch_z0/input_limits.txt --save_kfold --model_dir=models/pre_N_xLH_stitch_z0 --save_best --lr=0.02 --kfolds=27 --lgk=./data/pre_N_L-H_stitch_z0/kf.txt
...
python train_one.py --data_x=./data/pre_N_xL-H_stitch_z0/train_input.txt --data_y=./data/pre_N_xL-H_stitch_z0/train_output.txt --bound_x=./data/pre_N_xL-H_stitch_z0/input_limits.txt --model_dir=models/pre_N_xLH_stitch_z0 --lr=0.02 --model_name=best_model --lgk=./data/pre_N_L-H_stitch_z0/kf.txt --retrain
python train_one.py --data_x=./data/pre_N_xL-H_stitch_z0/train_input.txt --data_y=./data/pre_N_xL-H_stitch_z0/train_output.txt --bound_x=./data/pre_N_xL-H_stitch_z0/input_limits.txt --model_dir=models/pre_N_xLH_stitch_z0_0c --lr=0.02 --model_name=best_model --lgk=./data/pre_N_L-H_stitch_z0/kf.txt --retrain --zero_centering
python train_one.py --data_x=./data/pre_N_xL-H_stitch_z0/train_input.txt --data_y=./data/pre_N_xL-H_stitch_z0/train_output.txt --bound_x=./data/pre_N_xL-H_stitch_z0/input_limits.txt --model_dir=models/pre_N_xLH_stitch_z0_0c --lr=0.02 --model_name=best_model --lgk=./data/pre_N_L-H_stitch_z0/kf.txt --hidden_size=128 --decay=1.6438530100725147e-05 --num_layers=2 --zero_centering
...
python train_one.py --data_x=./data/pre_N_LHB_z0/train_input.txt --data_y=./data/pre_N_LHB_z0/train_output.txt --bound_x=./data/narrow/matter_power_297_Box100_Part75_27_Box100_Part300_z0/input_limits.txt --model_dir=models/pre_N_LHB_z0 --lr=0.02 --num_layers=1 --hidden_size=304 --decay=0.00016120080578261664 --model_name=best_model --lgk=./data/pre_N_L2B_z0/kf.txt 
python train_one.py --data_x=./data/pre_N_LHB_z0/train_input.txt --data_y=./data/pre_N_LHB_z0/train_output.txt --bound_x=./data/narrow/matter_power_297_Box100_Part75_27_Box100_Part300_z0/input_limits.txt --model_dir=models/pre_N_LHB_z0 --lr=0.02 --model_name=best_model --lgk=./data/pre_N_L2B_z0/kf.txt --retrain
